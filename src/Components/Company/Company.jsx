      ...
      <Row className="my-3">
        <Col xs={12} md={6} lg={3} className="mb-4">
          <Link to={`/search?city=القاهرة الجديدة`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title">القاهرة الجديدة</Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city=الشيخ زايد`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title">الشيخ زايد </Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={3} className="mb-4" >
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title className="company-title">مصر الجديدة </Card.Title>
            </Card.Body>
          </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city=مدينة نصر`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title">مدينة نصر </Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        ...
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city=6 اكتوبر`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title"> 6 أكتوبر</Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city=المعادي`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title">المعادى </Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city=مدينتي`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title">مدينتى </Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
        ...
        <Col xs={12} md={6} lg={3} className="mb-4" >
          <Link to={`/search?city= الساحل الشمالي`} className="card">
            <Card>
              ...
              <Card.Body>
                <Card.Title className="company-title"> الساحل الشمالي </Card.Title>
              </Card.Body>
            </Card>
          </Link>
        </Col>
