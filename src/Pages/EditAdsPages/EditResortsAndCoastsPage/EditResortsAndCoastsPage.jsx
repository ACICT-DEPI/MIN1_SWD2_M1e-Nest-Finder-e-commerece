...
const EditResortsAndCoastsPage = () => {
          ...
          <Row className="justify-content-center">
            <Col xs={12} md={10} lg={8}>
              <div className="shadow-sm p-4 mb-5 bg-white rounded">
                <h2 className="text-center mb-4"> مصايف وساحلي</h2>
                <ProgressBar
                  now={progress}
                  label={`${progress}%`}
                  className="my-4"
                  ...
                  {currentPage === 3 && (
                    <>
                      ...
                      <Row>
                        ...
                        {formData.sub_category !== "فيلا منفصلة" &&
                        formData.sub_category !== "تاون هاوس" &&
                        formData.sub_category !== "توين هاوس" ? (
                          <Col xs={12} md={6}>
                            <Form.Group
                              controlId="floor_number"
                              className="mb-3"
                            >
                              <Form.Label className="required">
                                الدور
                            ...
                            <div className="d-flex flex-wrap">
                              {oldImages.map((image, index) => (
                                ...
                                >
                                  <img
                                    key={index}
                                    src={image} alt={`AdditionalImage ${index}`}
                                    style={{
                                      maxWidth: "150px",
                                      height: "auto",
                                      margin: "0 10px 10px 0",
...
export default EditResortsAndCoastsPage;
