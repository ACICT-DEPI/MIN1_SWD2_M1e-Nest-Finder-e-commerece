...
import { faHome, faDollarSign,faBath, faRulerCombined } from '@fortawesome/free-solid-svg-icons';
                  ...
                  {currentPage === 7 && (
                    <>
                      ...
                      <Form.Group controlId="mall" className="mb-3">
                        ...
                        {Ad.property.mall_name && (
                          <p>اختيارك القديم:({Ad.property.mall_name})</p>
                        )}
                        <Autocomplete
                          disablePortal
...
export default EditCommercialUnitsPage;
