  ...
  useEffect(() => {
    const fetchAd = async () => {
      setFormData({
        ...
        "accessories[]": Ad.property.accessories,
          ...
          <Row className="justify-content-center">
            <Col xs={12} md={10} lg={8}>
              <div className="shadow-sm p-4 mb-5 bg-white rounded">
                <h2 className="text-center mb-4">منازل وبيوت</h2>
                <ProgressBar
                  now={progress}
                  label={`${progress}%`}
                  className="my-4"
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  {currentPage === 2 && (
                    <>
                      ...
                      {formData.type === "rent" && (
                        <Form.Group controlId="price_per" className="mb-3">
                          <Form.Label>السعر المعروض في </Form.Label>
                          <Form.Select
                            name="price_per"
...
export default EditHomePropertyPage;
