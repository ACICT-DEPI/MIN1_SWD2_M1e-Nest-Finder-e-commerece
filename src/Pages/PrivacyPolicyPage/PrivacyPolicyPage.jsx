...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div style={{ background: "#eee" }}>
      ...
      >
        في معرض Nest Finder خصوصية زوارنا لها اهمية بالغة بالنسبة لنا، سياسة
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        <p
          ...
          style={{ background: "#fff", color: "blue", borderRadius: "5px" }}
        >
          تطبق سياسة الخصوصية هذه على ويب سايت Nest Finder، وتطبيقاته وسارية
          على جميع العملاء سواء كانوا من مستخدمي الموقع عبر Nest Finder.com أو
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        >
          ...
          من سياسة الخصوصية هذه على الإنترنت من قبل إدارة Nest Finder يتحتم
          عليك التحقق من سياسة الخصوصية الخاصة بنا بشكل منتظم. استخدامك المستمر
          لموقع Nest Finderinderinderinder Nest Finder وتطبيقاته وخدماته يشكل موافقتك على سياسة الخصوصية
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        <p
          ...
          className=" p-2"
          style={{ background: "#fff", color: "blue", borderRadius: "5px" }}
        >معرض Nest Finderinder Nest Finder يستخدم تقنية الكوكيز لتخزين المعلومات عن تفضيلات الزوار، الى جانب سجل خاص للمستخدم تسجل فيه معلومات محددة عن الصفحات التي تم الوصول اليها او زيارتها، بهذه الخطوة فاننا نعرف مدى اهتمامات الزوار واي المواضيع الاكثر تفضيلا من قبلهم حتى نستطيع بدورنا تطوير محتوانا المعرفي المناسب لهم.</p>
      </div>
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        <p
          ...
          className=" p-2"
          style={{ background: "#fff", color: "blue", borderRadius: "5px" }}
        >شأنها في ذلك شأن معظم خوادم المواقع الاخرى ، ومن هنا في Nest Finder نستخدم نظام ملفات الدخول. وهذا يشمل بروتوكول الانترنت (عناوين ، نوع المتصفح ، مزود خدمة الانترنت (مقدمي خدمات الانترنت)، التاريخ / الوقت ، وعدد النقرات لتحليل الاتجاهات وادارة الموقع ).
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        <p
          ...
          className=" p-2"
          style={{ background: "#fff", color: "blue", borderRadius: "5px" }}
        >"فيما يتعلق باستخدامي المستمر لموقع Nest Finder ، أسمح بموجبه ل Nest Finder تحليل بيانات البروتوكول واستخدامها لتطوير وتحسين معرضهم للتسويق الإكتروني."</p>
      </div>
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        قد يتم التواصل معك على رقم هاتفك لاعلامك بأي مستجدات في تفضيلاتك، او مع الاعلانات الترويجية وتسهيلات عمليات الدفع. قد نستخدم المعلومات التي نجمعها لإجراء تحليلات ذات صلة بخدمة العملاء، ونقوم بتدريب موظفينا في خدمة العملاء، ونوفر لك الدعم المناسب للعملاء، حتى تحصلوا على أفضل تجربة عملاء من Nest Finder.
        </p>
      </div>
      ...
      <div className="fs-5 container my-1 p-2">
        ...
        <p
          ...
          className=" p-2"
          style={{ background: "#fff", color: "blue", borderRadius: "5px" }}
        >أقر بموجب ذلك أنني قرأت وفهمت سياسة الخصوصية هذه. من خلال إرسال البيانات إلى Nest Finder أو وكلائها أو استخدامي لموقع Nest Finder أو تطبيقاته أو خدماته، أوافق طوعا وبشكل صريح على جمع بياناتي ومشاركتها واستخدامها في الإجراءات والاحتفاظ بها على النحو المبين في سياسة الخصوصية هذه. </p>
      </div>
      <Footer />
    </div>
  );
