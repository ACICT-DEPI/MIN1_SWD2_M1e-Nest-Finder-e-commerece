...
export default function ShowPostsComments({ role }) {
  ...
  const handelGetPostsComments = async () => {
    try {
      ...
      if (error.response.status === 401) {
        ...
        setAlert({
          msg: "حدث خطأ اثناء استرجاع التعليقات .يرجى المحاوله مره اخرى",
          variant: 2,
        });
      }
      setShow(true);
